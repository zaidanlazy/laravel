                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('peminjaman.update', $peminjaman->PeminjamanID) }}">
                            ...
                            <div class="col-md-6">
                                <select name="UserID" class="form-control @error('UserID') is-invalid @enderror">
                                    ...
                                    @foreach($users as $user)
                                        <option value="{{ $user->id }}" {{ old('UserID', $peminjaman->UserID) == $user->id ? 'selected' : '' }}>
                                            {{ $user->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                <select id="BukuID" name="BukuID" class="form-select @error('BukuID') is-invalid @enderror" required>
                                    ...
                                    @forelse($buku as $buku)
                                        <option value="{{ $buku->BukuID }}" {{ old('BukuID', $peminjaman->BukuID) == $buku->BukuID ? 'selected' : '' }}>
                                            {{ $buku->Judul }}
                                        </option>
                                    @empty
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="TanggalPeminjaman" type="date" class="form-control @error('TanggalPeminjaman') is-invalid @enderror" name="TanggalPeminjaman" value="{{ old('TanggalPeminjaman', $peminjaman->TanggalPeminjaman) }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="TanggalPengembalian" type="date" class="form-control @error('TanggalPengembalian') is-invalid @enderror" name="TanggalPengembalian" value="{{ old('TanggalPengembalian', $peminjaman->TanggalPengembalian) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="StatusPeminjaman" name="StatusPeminjaman" class="form-select @error('StatusPeminjaman') is-invalid @enderror" required>
                                    ...
                                    <option value="Terlambat" {{ old('StatusPeminjaman', $peminjaman->StatusPeminjaman) == 'Terlambat' ? 'selected' : '' }}>Terlambat</option>
                                </select>
